        ...
        <Card sx={{ display: "flex", direction: "collumn", paddingX: 1, paddingY: 1, border: 1}}>
            <Grid container direction="column">
                ...
                <Grid item container direction="row" justifyContent="flex-end" alignItems="center">
                    <Button sx={{fontSize: 14, padding:0, marginX: 1}} variant="outlined" onClick={decrease}>-</Button>
                    <Typography variant="h5">{count}</Typography>
                    <Button sx={{fontSize: 14, padding:0, marginX: 1}} variant="outlined" onClick={increase}>+</Button>
                </Grid>
            </Grid>
        </Card>
    );
